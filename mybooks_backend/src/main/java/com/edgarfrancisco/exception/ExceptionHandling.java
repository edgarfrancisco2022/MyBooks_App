...
public class ExceptionHandling implements ErrorController {
    ...
    public ResponseEntity<HttpResponse> bookNotFound(BlankSearchQueryException exception) {
        return createHttpResponse(BAD_REQUEST, exception.getMessage());
    }

    @ExceptionHandler(ListAlreadyExistsException.class)
    public ResponseEntity<HttpResponse> listAlreadyExists(ListAlreadyExistsException exception) {
        return createHttpResponse(BAD_REQUEST, exception.getMessage());
    }

    @ExceptionHandler(ListNotFoundException.class)
    public ResponseEntity<HttpResponse> listNotFound(ListNotFoundException exception) {
        return createHttpResponse(BAD_REQUEST, exception.getMessage());
    }
