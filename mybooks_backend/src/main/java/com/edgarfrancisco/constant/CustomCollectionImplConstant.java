...
public class CustomCollectionImplConstant {

    public static final String LIST_ALREADY_EXISTS = "List already exists. Please try a different name.";
    public static final String LIST_NOT_FOUND = "No list found by name: ";
